        ...
        <>
            <form className="flex flex-col gap-2 w-full" onSubmit={handleSubmit}>
                ...
                <div className="my-2 flex flex-col w-full gap-2">
                    ...
                    <input className="px-2 py-3 outline-none border-2 rounded-lg border-[rgba(0,0,0,.25)]" type='text' name="representative" value={values.representative} onChange={handleChange} id="representative" />
                </div>
                <div className="my-2 flex flex-col w-full w-full gap-2">
                    ...
                    <input className="px-2 py-3 outline-none border-2 rounded-lg border-[rgba(0,0,0,.25)]" type='text' name="code" value={values.code} onChange={handleChange} id="code" />
                </div>
