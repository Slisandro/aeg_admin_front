...
export const DashboardPage = () => {
    ...
    if (usersCount.isLoading || clientsCount.isLoading || coursesCount.isLoading) return (
        <div role="status" className="col-span-2 lg:row-start-2 w-full h-full flex items-center justify-center">
            <svg aria-hidden="true" className="w-16 h-16 text-gray-200 animate-spin fill-[#2d68a2]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
